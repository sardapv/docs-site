...
You will be learning them in the future here [Functions](/docs/c/functions).
...
What's happening here?
  ...
  **%d** is `int` format specifier.
  ...
  It means the value entered by the user is storing in the address of declared variable `a`.
